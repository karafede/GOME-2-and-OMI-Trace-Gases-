...
%function Read_he5_AERO(FILE_NAME_a,output_directory, AERO_date)
...
for i=1:length(data_vect)
      ...
      distance = sqrt((Lat_AURUN(j)- LAT_AERO(i))^2 + (Lon_AURUN(j)- LON_AERO(i))^2);
...
[OMI_AERO_AURUN] =[Lat_AURUN, Lon_AURUN, data_NEW]; 
cd('Z:\omi_l3\processedAERO\04');

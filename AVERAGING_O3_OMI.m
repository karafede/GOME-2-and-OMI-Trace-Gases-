...
function AVERAGING_O3_OMI(directory_name,AVG_O3_OMI_WW, AVG_O3_OMI_EU,AVG_O3_OMI_UK,...
         AVG_O3_OMI_csv,AVG_O3_AURUN_OMI_csv,output_directory)  %%% filename_txt is a list of daily files (TXT file: 20Jan2015_O3_OMI)
...
csvwrite_with_headers(AVG_O3_OMI_csv,O3_OMI,headers_OMI);
